...
export default {
  ...
  owner: process.env.OWNER_NUMBER || "917980046966",
  sudo: process.env.SUDO || "917980046966",
  packname: process.env.PACKNAME || "𝐗𝐃",
  author: process.env.AUTHOR || "চন্দ্রবিন্দুর চাঁদ",
